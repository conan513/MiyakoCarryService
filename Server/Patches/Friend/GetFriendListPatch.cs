...
namespace MiyakoCarryService.Server.Patches.Friend
{
    ...
    public sealed class GetFriendListPatch : AbstractPatch
    {
        ...
        {
            var targetCount = _configController.GetMcsPluginConfig()?.ServerConfig?.AutoGenerateBotCount ?? 100;
            _profileController.EnsureAutoGeneratedBots(sessionId, targetCount);
